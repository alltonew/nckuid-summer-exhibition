...
/* 移動滾軸 */
$('#A6').click(function(){$('html,body').animate({scrollTop:'830px'},500);});
$('#A7').click(function(){$('html,body').animate({scrollTop:'2630px'},500);});
$('#A8').click(function(){$('html,body').animate({scrollTop:'3430px'},500);});
$('#A9').click(function(){$('html,body').animate({scrollTop:'4360px'},500);});

$('#B1').click(function(){$('html,body').animate({scrollTop:'0px'},500);});
$('#B2').click(function(){$('html,body').animate({scrollTop:'830px'},500);});
$('#B3').click(function(){$('html,body').animate({scrollTop:'2630px'},500);});
$('#B4').click(function(){$('html,body').animate({scrollTop:'3430px'},500);});
$('#B5').click(function(){$('html,body').animate({scrollTop:'4360px'},500);});
