...
/* 移動滾軸 */
$('#A6').click(function(){$('html,body').animate({scrollTop:'760px'},500);});
$('#A7').click(function(){$('html,body').animate({scrollTop:'2430px'},500);});
$('#A8').click(function(){$('html,body').animate({scrollTop:'3230px'},500);});
$('#A9').click(function(){$('html,body').animate({scrollTop:'4060px'},500);});

$('#B1').click(function(){$('html,body').animate({scrollTop:'0px'},500);});
$('#B2').click(function(){$('html,body').animate({scrollTop:'760px'},500);});
$('#B3').click(function(){$('html,body').animate({scrollTop:'2430px'},500);});
$('#B4').click(function(){$('html,body').animate({scrollTop:'3230px'},500);});
$('#B5').click(function(){$('html,body').animate({scrollTop:'4060px'},500);});

<!-- 圖片切換 --!>
$("#typeAll").click(function(){$(".A").css("display","inline");$(".B").css("display","inline")})
